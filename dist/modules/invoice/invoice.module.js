...
const invoice_prisma_repository_1 = require("./infrastructure/invoice.prisma.repository");
...
exports.InvoiceModule = InvoiceModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [
            ...
            {
                provide: invoice_repository_1.INVOICE_REPOSITORY,
                useClass: invoice_prisma_repository_1.InvoicePrismaRepository
            }
        ],
