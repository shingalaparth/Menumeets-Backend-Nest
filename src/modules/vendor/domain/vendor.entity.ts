/**
 * Vendor Entity — Domain layer
 * Pure TypeScript interfaces, decoupled from Prisma.
 */
...
export interface VendorKyc {
    ...
    panNumber?: string;
    aadhaarFrontImage?: { url: string; publicId: string };
    aadhaarBackImage?: { url: string; publicId: string };
...
export interface VendorBankDetails {
    ...
    branch?: string;
    upiId?: string;
    cancelledChequeImage?: { url: string; publicId: string };
    passbookImage?: { url: string; publicId: string };
    status?: string;
    rejectionReason?: string;
}
